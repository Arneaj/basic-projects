...
# ╔═╡ 08057386-346a-11ef-39d6-e3f529dd8fb2
using Symbolics, LinearAlgebra, ModelingToolkit, NonlinearSolve

# ╔═╡ d7266eb2-d7cb-4acd-9a7e-10bc3ff4f556
@variables n_1::Int, n_2::Int, n_2p::Int

# ╔═╡ ce240755-1d87-40fb-8ba7-0267c92caa2c
@parameters L_1, L_2, L_2p, L_3, n_3::Int

# ╔═╡ b3f4e302-c817-43b8-b396-9b8989d2216f
sys = [
	(2*n_1)/(2*n_2) ~ L_1/L_2,
	(2*n_1)/(2*n_2p) ~ L_1/L_2p,
	(2*n_1)/(2*n_3) ~ L_1/L_3
]

# ╔═╡ fa6de618-7f41-4695-8a89-f62f1c4c101f
@named ns = NonlinearSystem(sys, [n_1,n_2,n_2p],[L_1, L_2, L_2p, L_3,n_3])

# ╔═╡ 16f2a62b-c63a-41e2-8329-e6590f8a3658
nss = structural_simplify(ns)

# ╔═╡ 6166f5ab-1bb4-40be-87df-2fff3bfa4638
guess = [n_1 => 1, n_2 => 1, n_2p => 1];

# ╔═╡ 660e1f12-3712-46cd-90f9-60cbb5e62c74
ps = [L_1 => 6.0, L_2 => 6.0, L_2p => 9.0, L_3 => 3.0, n_3 => 1 ];

# ╔═╡ e9b48a74-a849-4986-92f9-320a68f2a157
prob = NonlinearProblem(nss, guess, ps, jac = true);

# ╔═╡ 7822611f-666c-4a86-bb88-fc22ff211cb7
sol = solve(prob); sol
...
manifest_format = "2.0"
project_hash = "fe1dbc14139e0544eeb36326cd1c87126900ccc2"
